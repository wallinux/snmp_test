...
init_netSnmpIETFWGTable(void)
{
   ...
   const char *index_char[] = {"hickory","joe","hickory","bob","new orleans","help"};
   const char *chair = "John Black";
   int i,j;
   ...
   */
   ...
   CONTAINER_FOR_EACH(cb.container, (netsnmp_container_obj_func *)print_string, NULL);
